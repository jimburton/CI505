...
/* package huffman-exercise-0.1.0.0 */
#ifndef VERSION_huffman_exercise
#define VERSION_huffman_exercise "0.1.0.0"
#endif /* VERSION_huffman_exercise */
#ifndef MIN_VERSION_huffman_exercise
#define MIN_VERSION_huffman_exercise(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_huffman_exercise */
...
#define CURRENT_COMPONENT_ID "huffman-exercise-0.1.0.0-inplace-huffman-tests"
